    ...
    methods
        ...
        function z = plus(x, y)
            ...
            elseif isa(y, 'sequence') == 0
                ...
                Dx = [zeros(1, x.offset - y.offset) x.data zeros(1,
                LIy - LIx)];
                Dy = [zeros(1, y.offset - x.offset) y.data zeros(1,
                LIx - LIy)];
                Dz = Dx + Dy;
        ...
        function z = minus(x, y)
            % MINUS Subtract x and y. Either x and y will both be sequence
            structures, or one of them may be a number.
            if isa(x, 'sequence') == 0
                z = sequence(x - y.data, y.offset);
                return;
        ...
        function z = times(x, y)
            % TIMES Multiply x and y (i.e. .*) Either x and y will both be
